    ...
    public partial class Default : System.Web.UI.Page {
        ...
        protected void ASPxScheduler1_PopupMenuShowing(object sender, DevExpress.Web.ASPxScheduler.PopupMenuShowingEventArgs e) {
            if(e.Menu.Id == DevExpress.XtraScheduler.SchedulerMenuItemId.AppointmentMenu) {
                ...
                DevExpress.Web.ASPxMenu.MenuItem newItem = new DevExpress.Web.ASPxMenu.MenuItem();
                newItem.Name = "CustomValues";
                newItem.Text = "Custom values";
                int i = 0;
                foreach(string customFieldValue in customFieldValues) {
                    DevExpress.Web.ASPxMenu.MenuItem subMenuItem = new DevExpress.Web.ASPxMenu.MenuItem();
